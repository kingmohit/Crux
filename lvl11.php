    ...
    <div class="container-fluid">
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <fieldset>
		  <legend>LEVEL 11</legend>
            <img border="0" src="/crux2/img/lvl11a.png"  /> 
			<img border="0" src="/crux2/img/lvl11b.png"  />
            <img border="0" src="/crux2/img/lvl11c.png" width="250" />   <br/>
			<img border="0" src="/crux2/img/lvl11d.png"  />   <br/> <br/>
...
<!--if nothing strikes your mind..try going towards number nine!!-->
