      ...
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <legend>LEVEL 2</legend>
            <img border="0" src="/crux2/img/lvl2a.png"  /> 
			<img border="0" src="/crux2/img/lvl2b.png" width="30%" /> <br/>
            <img border="0" src="/crux2/img/lvl2c.png"  /> <br/> <br/>
