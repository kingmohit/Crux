    ...
    <div class="container-fluid">
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <fieldset>
		  <legend>LEVEL 24</legend>
            <img border="0" src="/crux2/img/lvl24a.png" width="30%" /> 
			<img border="0" src="/crux2/img/lvl24b.png" width="30%" />
            <img border="0" src="/crux2/img/lvl24c.png" width="20%" /> <br/> <br/>
