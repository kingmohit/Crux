      ...
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <legend>LEVEL 1</legend>
            <img border="0" src="/crux2/img/lvl1a.png" /> 
			<img border="0" src="/crux2/img/lvl1b.png" /> 
			<p><br/> If you don't get this you might as well quit now. </p>
