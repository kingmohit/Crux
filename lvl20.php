<?php
header('Location: http://ifest.ieeeiitr.com/crux2/end.php');
exit;
?>
<?PHP
    ...
    <div class="container-fluid">
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <fieldset>
		  <legend>LEVEL 20</legend>
            <img border="0" src="/crux2/img/lvl20a.png"  /> 
			<img border="0" src="/crux2/img/lvl20b.png"  />
            <img border="0" src="/crux2/img/lvl20c.png"  /> <br/> <br/>
			<input type="text" name="ans" id="ans" placeholder="Answer here" onclick="this.placeholder=''"/>
            <p><button class="btn btn-primary btn-large" type="submit" name="sub_ans">Are u sure &raquo;</button></p>
			</fieldset>
			</form>
          </div>
        </div>
