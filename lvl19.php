    ...
    <div class="container-fluid">
      <div class="row-fluid" id="row-fluid" >
        ...
        <div class="span9"id="span9">
		  ...
		  <fieldset>
		  <legend>LEVEL 19</legend>
            <img border="0" src="/crux2/img/lvl19a.jpg" width="30%" /> 
			<img border="0" src="/crux2/img/lvl19b.png" title="Legendary" width="40%" /> <br/> <br/>
